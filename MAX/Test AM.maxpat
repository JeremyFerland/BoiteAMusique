...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 161.333344, 489.333344, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 161.333344, 536.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "metro 800"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 238.666687, 745.333374, 34.0, 22.0 ],
					"style" : "",
					"text" : "+ 40"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 161.333344, 576.000061, 160.0, 145.0 ],
					"range" : 100,
					"size" : 30,
					"style" : "",
					"table_data" : [ 0, 18, 18, 19, 21, 27, 30, 49, 58, 66, 74, 78, 80, 85, 85, 85, 83, 80, 74, 65, 59, 58, 54, 44, 33, 31, 30, 28, 20, 16, 54 ]
				}
...
, 			{
				"box" : 				{
					...
					"noteFun" : 					{
						...
						"noteFun20004" : [ "loop", 0, 1.0, 30.0 ],
						"noteFun20005" : [ "playheadPosition", 544.017952 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1315.0, 1333.333374, 85.0, 22.0 ],
					"style" : "",
					"text" : "send MasterR"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 819.5, 1528.0, 63.0, 22.0 ],
					"style" : "",
					"text" : "r MasterR"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 756.0, 1528.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "r MasterL"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1283.5, 1359.333374, 83.0, 22.0 ],
					"style" : "",
					"text" : "send MasterL"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 778.5, 1567.666626, 45.0, 45.0 ],
					"style" : ""
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-44.4::obj-19" : [ "live.gain~[130]", "live.gain~", 0 ],
			...
			"obj-44.12::obj-5" : [ "live.gain~[168]", "live.gain~[82]", 0 ],
			...
			"obj-44.1::obj-32" : [ "live.gain~[112]", "live.gain~", 0 ],
			...
			"obj-44.2::obj-34" : [ "live.gain~[118]", "live.gain~", 0 ],
			...
			"obj-44.19::obj-34" : [ "live.gain~[203]", "live.gain~", 0 ],
			"obj-84.14::obj-32" : [ "live.gain~[64]", "live.gain~", 0 ],
			"obj-44.1::obj-19" : [ "live.gain~[116]", "live.gain~", 0 ],
			...
			"obj-44.20::obj-32" : [ "live.gain~[209]", "live.gain~", 0 ],
			...
			"obj-84.13::obj-33" : [ "live.gain~[58]", "live.gain~", 0 ],
